                    ...
                    <div class="responsive-tabs">
                        ...
                        <div class="section">
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td><input type="text" name="wf_swipe" style="width:400px; height:40px" value="<?php echo esc_attr(get_option('wf_swipe')); ?>" />
                                ...
                                <tr valign="top">
                                    ...
                                    <td><input type="text" name="wf_poster_imageurl" style="width:400px; height:40px" value="<?php echo esc_attr(get_option('wf_poster_imageurl')); ?>" /><br />
                                        <p style="color: #959595; display:inline">* 请输完整的图片网址，例如：https://www.watch-life.net/images/poster.jpg</p>
                                    </td>
                                </tr>

                                <tr valign="top">
                                    <th scope="row">CDN 默认网址</th>
                                    <td><input type="text" name="wf_cdn_url" style="width:400px; height:40px" value="<?php echo esc_attr(get_option('wf_cdn_url')); ?>" /><br />
                                        <p style="color: #959595; display:inline">* 请输完整的 CDN 网址，例如：https://cdn.yoursite.com/</p>
                                    </td>
                                </tr>

                                <tr valign="top">
                                    <th scope="row">头像 CDN 默认网址</th>
                                    <td><input type="text" name="wf_avatar_cdn_url" style="width:400px; height:40px" value="<?php echo esc_attr(get_option('wf_avatar_cdn_url')); ?>" /><br />
                                        <p style="color: #959595; display:inline">* 请输完整的头像 CDN 网址，例如：https://cdn.yoursite.com/，留空则默认使用 CDN 网址</p>
                                    </td>
                                </tr>
                        ...
                        <div class="section">
                            <div style="display: flex; flex-direction: row; margin-bottom: 10px">
                                ...
                                <a href="https://mall.minapper.com" target="_blank" style="text-decoration: none">
